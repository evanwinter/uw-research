...
<div class="featured-content-bar">
    <a href="#" class="featured-post">
        <div class="featured-post-image">
            ...
            <!-- <span class="featured-post-caption">post 1</span> -->
        </div>
    </a>
    <a href="#" class="featured-post">
        <div class="featured-post-image">
            <img  class="featured-post-image" src="images/research-2.jpg">
            <!-- <span class="featured-post-caption">post 2</span> -->
        </div>
    </a>
    <a href="#" class="featured-post">
        <div>
            <img  class="featured-post-image" src="images/research-3.jpg">
            <!-- <span class="featured-post-caption">post 3</span> -->
        </div>
    </a>
...
<div class="post-content">
	...
	<div class="posts">
		...
		<div class="post">
			<div class="post-info">
				<a href="#" class="post-date"> May 4, 2017 </a> | <a href="#" class="post-author"> Ningyuan Ma </a>
				<a class="#" href=""><h1>Research funding over time</h1></a>
				<p class="excerpt">A brief excerpt that will give readers a taste of what the piece is ultimately about. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
			</div>
		...
		<div class="post">
			<div class="post-info">
				<a href="#" class="post-date"> May 4, 2017 </a> | <a href="#" class="post-author"> Marissa Sugrue </a>
				<a class="#" href=""><h1>Life of a researcher</h1></a>
				<p class="excerpt">A brief excerpt that will give readers a taste of what the piece is ultimately about. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
			</div>
			<div class="post-body hide">
		...
		<div class="post">
			<div class="post-info">
				<a href="#" class="post-date"> May 4, 2017 </a> | <a href="#" class="post-author"> Steven Potter </a>
				<a class="#" href=""><h1>Research rankings and their importance</h1></a>
				<p class="excerpt">A brief excerpt that will give readers a taste of what the piece is ultimately about. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
			</div>
			<div class="post-body hide">
		...
		<div class="post">
			<div class="post-info">
				...
				<a class="#" href=""><h1>Non-STEM Research</h1></a>
				<p class="excerpt">A brief excerpt that will give readers a taste of what the piece is ultimately about. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
			</div>
			<div class="post-body hide">
		...
		<div class="post">
			<div class="post-info">
				<a href="#" class="post-date"> May 4, 2017 </a> | <a href="#" class="post-author"> Jack Kelly </a>
				<a class="#" href=""><h1>Research: Wisconsin vs. Michigan</h1></a>
				<p class="excerpt">A brief excerpt that will give readers a taste of what the piece is ultimately about. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
			</div>
			<div class="post-body hide">
	...
	<div class="sidebar-content">
		Stories
		<ul>
			<a href=""><li>Research funding over time</li></a>
			<a href=""><li>Life of a researcher</li></a>
			<a href=""><li>Research rankings and their importance</li></a>
			<a href=""><li>Non-STEM Research</li></a>
			<a href=""><li>Research: Wisconsin vs. Michigan</li></a>
		</ul>

		ASFs
		<ul>
			<a href=""><li>ASF 1</li></a>
			<a href=""><li>ASF 2</li></a>
			<a href=""><li>ASF 3</li></a>
			<a href=""><li>ASF 4</li></a>
			<a href=""><li>ASF 5</li></a>
		</ul>

		Multimedia
		<ul>
			<a href=""><li>Radio story</li></a>
			<a href=""><li>Intro video</li></a>
		</ul>
	</div>
